...
export default function TeacherAuth() {
  ...
  if (!loading && user) return <Navigate to="/teacher-dashboard" replace />;
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      const u = cred.user;
      await registerUserInBackend(u.uid, u.email, u.displayName || u.email, 'teacher');
  ...
  async function handleOTP(e) {
    ...
    try {
      ...
      await registerUserInBackend(u.uid, data.email, data.name, 'teacher', data.orgCode);
      localStorage.setItem('firebaseUid', u.uid);
      localStorage.setItem('userRole', 'teacher');
  ...
  async function handleMicrosoft() {
    try {
      ...
      await registerUserInBackend(u.uid, u.email, u.displayName || u.email, 'teacher', orgCode);
      localStorage.setItem('firebaseUid', u.uid);
      localStorage.setItem('userRole', 'teacher');
      localStorage.setItem('userName', u.displayName || u.email);
      localStorage.setItem('userEmail', u.email);
      ...
      <div style={cardStyle}>
        {view === 'login' && (
          <form onSubmit={handleLogin}>
            ...
            <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#1e293b' }}>Teacher Login</h2>
        ...
        {view === 'signup' && (
          <form onSubmit={handleSignup}>
            <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#1e293b' }}>Teacher Signup</h2>
            <div style={inputGroupStyle}>
